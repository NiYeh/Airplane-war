...
proc main() =
  initWindow(ScreenWidth, ScreenHeight, "Airplane War")

  MessageBoxA(0,"Have fun!","Windows",0)

  var
# =============================================== 背景圖
    bgImage:Image = loadImage("resources/sky.png")
    bgTexture:Texture2D = loadTextureFromImage(bgImage)

# =============================================== 火箭圖 
    rImage:Image = loadImage("resources/rocket.png")
    rTexture:Texture2D = loadTextureFromImage(rImage)

# =============================================== 勝利圖 
    winImage:Image = loadImage("resources/win.png")
    winTexture:Texture2D = loadTextureFromImage(winImage)

# =============================================== 失敗圖 
    loseImage:Image = loadImage("resources/gameover.png")
    loseTexture:Texture2D = loadTextureFromImage(loseImage)

# =============================================== rock1圖 
    r1Image:Image = loadImage("resources/rock1.png")
    r1Texture:Texture2D = loadTextureFromImage(r1Image)

# =============================================== rock2圖 
    r2Image:Image = loadImage("resources/rock2.png")
    r2Texture:Texture2D = loadTextureFromImage(r2Image)

# =============================================== rock3圖
    r3Image:Image = loadImage("resources/rock3.png")
    r3Texture:Texture2D = loadTextureFromImage(r3Image)

# =============================================== 金錢圖
    mImage:Image = loadImage("resources/money.png")
    mTexture:Texture2D = loadTextureFromImage(mImage)

# =============================================== 愛心圖
    hImage:Image = loadImage("resources/heart.png")
    hTexture:Texture2D = loadTextureFromImage(hImage)

# =============================================== 子彈圖 
    bImage:Image = loadImage("resources/bullet.png")
